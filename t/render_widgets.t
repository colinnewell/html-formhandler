...
<div><label class="label" for="hobbies.0">0: </label><input type="text" name="hobbies.0" id="hobbies.0" tabindex="2" value="" /></div>
</fieldset></div>
...
is(
    $output13, '
<div><fieldset class="hobbies"><legend>Hobbies</legend>
<div><label class="label" for="hobbies.0">0: </label><input type="text" name="hobbies.0" id="hobbies.0" tabindex="2" value="eating" /></div>

<div><label class="label" for="hobbies.1">1: </label><input type="text" name="hobbies.1" id="hobbies.1" tabindex="2" value="sleeping" /></div>

<div><label class="label" for="hobbies.2">2: </label><input type="text" name="hobbies.2" id="hobbies.2" tabindex="2" value="not chasing mice" /></div>
</fieldset></div>
